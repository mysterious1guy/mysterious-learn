    ...
    },
    {
        ...
        chapters: [
            ...
            },
            {
                ...
                order: 2,
                duration: "5 heures",
                content: "Dès qu'un algorithme devient long, il faut le diviser en sous-programmes appelés fonctions ou procédures. Une fonction prend des entrées (paramètres), effectue un calcul, et retourne une sortie (valeur de retour). Cela permet de ne pas se répéter (principe DRY : Don't Repeat Yourself) et de rendre le code beaucoup plus lisible.",
