...
const CourseCarousel = ({ courses }) => {
    ...
    return (
        <div className="relative w-full max-w-6xl mx-auto mt-12 mb-24 px-4 group">
            <div className="relative h-[600px] md:h-[500px] overflow-hidden rounded-[2.5rem]">
                        ...
                        <div className="w-full h-full bg-slate-900/60 backdrop-blur-md border border-slate-700 rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row shadow-2xl relative">
                            ...
                            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                                <div className="flex gap-2 mb-4">
                                    ...
                                    <div className="ml-auto px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[10px] font-black text-white/40 tabular-nums">
            ...
            {/* Navigation Buttons */}
            <div className="absolute left-0 lg:-left-16 top-1/2 -translate-y-1/2 z-20">
                <button
                    onClick={prevSlide}
                    className="p-3 bg-slate-900/80 backdrop-blur-md border border-slate-700 text-white rounded-full hover:bg-slate-800 transition-all opacity-0 group-hover:opacity-100 shadow-xl"
                >
                    <ChevronLeft size={24} />
                </button>
            </div>
            <div className="absolute right-0 lg:-right-16 top-1/2 -translate-y-1/2 z-20">
                <button
                    onClick={nextSlide}
                    className="p-3 bg-slate-900/80 backdrop-blur-md border border-slate-700 text-white rounded-full hover:bg-slate-800 transition-all opacity-0 group-hover:opacity-100 shadow-xl"
                >
