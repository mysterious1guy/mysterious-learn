...
const Navbar = ({ user, onMenuClick, onShowUsageMonitor, onSearch, API_URL }) => {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 p-2 sm:p-4 border-b border-slate-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-[60] transition-colors duration-300">
