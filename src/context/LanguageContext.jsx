...
export const translations = {
    fr: {
        ...
        home: {
            ...
            hero_desc: "L'arène d'entraînement ultime pour <strong class=\"text-slate-900\">apprendre la cybersécurité</strong>, maîtriser le développement web et résoudre des missions pratiques de hacking éthique.",
            objective_title: "Objectif de la plateforme",
            objective_desc: "MYSTERIOUS CLASSROOM est une plateforme d'entraînement pratique interactive. Ma vocation est de vous plonger dans des projets réels et des exercices guidés où chaque mission consiste à créer du code, trouver des failles de sécurité, protéger des serveurs et relever des défis concrets pour devenir un expert.",
            ...
            intercept_desc: "J'injecte actuellement de nouvelles missions pratiques de code et de cybersécurité. La plateforme évolue. Préparez-vous à relever de nouveaux défis imminents.",
    ...
    en: {
        ...
        home: {
            title_part1: "MYSTERIOUS",
            title_part2: "CLASSROOM",
            hero_desc: "The ultimate training arena to learn cybersecurity, master web development, and solve hands-on ethical hacking missions.",
            objective_title: "Platform Objective",
            objective_desc: "MYSTERIOUS CLASSROOM is an interactive hands-on training platform. My vocation is to immerse you in real projects and guided challenges where each mission consists of writing code, finding security flaws, securing servers, and forging your tech expertise.",
            ...
            intercept_desc: "I am currently injecting new practical coding and cybersecurity missions into the system. The platform is evolving. Prepare for new upcoming challenges.",
