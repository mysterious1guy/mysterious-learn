...
const HomePage = ({ API_URL }) => {
    ...
    return (
        <div className="min-h-screen bg-transparent font-sans selection:bg-blue-500/30">
            ...
            <div className="py-24 bg-slate-50 dark:bg-[#050814] relative border-t border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16 space-y-4">
                        <div className="flex items-center justify-center gap-3 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-600 dark:text-blue-400 text-sm font-bold tracking-widest uppercase mx-auto w-max mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* Windows */}
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-blue-500/50 transition-all group shadow-xl">
                            ...
                            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">Windows PC</h3>
                            <p className="text-sm text-slate-600 dark:text-slate-400 font-medium mb-6">Installation rapide via Microsoft Edge ou Chrome.</p>
                        ...
                        {/* Android */}
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-green-500/50 transition-all group shadow-xl">
                        ...
                        {/* Apple */}
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-slate-400/50 transition-all group shadow-xl">
                            ...
                            <div className="space-y-3 text-sm text-slate-500 dark:text-slate-400 font-medium bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                ...
                                <p>2. Appuyez sur l'icône de <b className="text-slate-800 dark:text-white">Partage</b> ⍗ (en bas).</p>
                                <p>3. Glissez et choisissez <b>Sur l'écran d'accueil</b>.</p>
                            </div>
                        </div>

                        {/* Linux */}
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-yellow-500/50 transition-all group shadow-xl">
                            <div className="w-14 h-14 bg-yellow-50 dark:bg-yellow-500/10 text-yellow-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">Linux & Unix</h3>
                            <p className="text-sm text-slate-600 dark:text-slate-400 font-medium mb-6">Compatible avec Chromium et Google Chrome.</p>
                            <div className="space-y-3 text-sm text-slate-500 dark:text-slate-400 font-medium bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-100 dark:border-slate-800 font-mono">
